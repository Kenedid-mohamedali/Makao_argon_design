<template>
<div>
    <b-navbar toggleable="lg" type="black" variant="dark">
        <b-navbar-brand href="#">
            <img src="img/images/Logo-Makao.png" style="width:50px; height:50px;" alt="Mon site">
        </b-navbar-brand>
        ...
        <b-navbar-nav>
            ...
            <b-nav-item href="Bocal.vue">Le Bocal</b-nav-item>
            <b-nav-item href="#">Notre projet</b-nav-item>
