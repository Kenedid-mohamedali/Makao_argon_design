    ...
    <footer class="footer has-cards">
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                <div class="col-lg-6">
                    <h3 class="text-success font-weight-light mb-2">Merci de nous soutenir!</h3>
                    <h4 class="mb-0 font-weight-light">Gardons le contact sur ces plateformes.</h4>
                </div>
                <div class="col-lg-6 text-lg-center btn-wrapper">
                    ...
                    <a target="_blank" rel="noopener" href="https://instagram.com/creativetim"
                        class="btn btn-neutral btn-icon-only btn-instagram btn-lg btn-round" data-toggle="tooltip"
                        data-original-title="Follow us">
                        <i class="fa fa-instagram"></i>
                    </a>

                    <a target="_blank" rel="noopener" href="https://www.youtube.com/creativetim"
                        class="btn btn-neutral btn-icon-only btn-youtube btn-round btn-lg" data-toggle="tooltip"
                        data-original-title="Like us">
                        <i class="fa fa-youtube"></i>
                    </a>
                    <a target="_blank" rel="noopener" href="https://www.pinterest.com/creativetim"
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; {{year}}
                        <a href="https://www.creative-tim.com" target="_blank" rel="noopener">Creative Tim</a> & <a href="https://www.binarcode.com" target="_blank" rel="noopener">Binar Code</a> & <a>Mohamed Ali Kénédid et Marine BZ</a>
                    </div>
                </div>
                <div class="col-md-6">
